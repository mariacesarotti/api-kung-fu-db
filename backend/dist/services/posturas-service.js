...
var posturas_service_exports = {};
__export(posturas_service_exports, {
  createPosturaService: () => createPosturaService,
  deletePosturaByIdService: () => deletePosturaByIdService,
  getFullKatiService: () => getFullKatiService,
  getPosturaByIdService: () => getPosturaByIdService,
  getPosturaService: () => getPosturaService,
  updatePosturasByIdService: () => updatePosturasByIdService
});
module.exports = __toCommonJS(posturas_service_exports);
...
0 && (module.exports = {
  createPosturaService,
  deletePosturaByIdService,
  getFullKatiService,
  getPosturaByIdService,
  getPosturaService,
  updatePosturasByIdService
});
