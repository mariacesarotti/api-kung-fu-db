...
var posturas_controller_exports = {};
__export(posturas_controller_exports, {
  createPostura: () => createPostura,
  deletePosturaById: () => deletePosturaById2,
  getFullKati: () => getFullKati2,
  getPostura: () => getPostura,
  getPosturaById: () => getPosturaById,
  updatePosturaById: () => updatePosturaById2
});
module.exports = __toCommonJS(posturas_controller_exports);
